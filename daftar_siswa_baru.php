                    ...
                    <div class="card-content">
                        <form method="post" action="">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group label-floating">
                                        <label class="control-label">Di Semarang ikut</label>
                                        <input type="text" class="form-control" name="in_semarang_follow" 
										value="<?php isset($_SESSION['in_semarang_follow'])  ?  print($_SESSION['in_semarang_follow']) : ""; ?>"
                                        required>
                                    </div>
                                </div>
                            </div>
